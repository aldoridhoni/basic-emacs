...
#+BEGIN_SRC emacs-lisp
  (config/_downloader "https://www.emacswiki.org/emacs/download/frame-fns.el" "frame-fns.el" nil t)
#+END_SRC

- frame-cmds.el : needed by zomm-frm.el
#+BEGIN_SRC emacs-lisp
  (config/_downloader "https://www.emacswiki.org/emacs/download/frame-cmds.el" "frame-cmds.el" nil t)
#+END_SRC

- zoom-frm.el
#+BEGIN_SRC emacs-lisp
  (config/_downloader "https://www.emacswiki.org/emacs/download/zoom-frm.el" "zoom-frm.el" nil t)
#+END_SRC

- thingatpt+.el
#+BEGIN_SRC emacs-lisp
  (config/_downloader "https://www.emacswiki.org/emacs/download/thingatpt%2b.el" "thingatpt+.el" nil t)
#+END_SRC

- strings.el
#+BEGIN_SRC emacs-lisp
  (config/_downloader "https://www.emacswiki.org/emacs/download/strings.el" "strings.el" nil t)
#+END_SRC

- misc-fns.el
#+BEGIN_SRC emacs-lisp
  (config/_downloader "https://www.emacswiki.org/emacs/download/misc-fns.el" "misc-fns.el" nil t)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package elfeed
    ...
    (let ((feed-file (expand-file-name "elfeed-feed.el" user-emacs-directory)))
      (when (file-exists-p feed-file) (load-file feed-file))))
#+END_SRC
** Imenu-list
#+BEGIN_SRC emacs-lisp
...
** Org Export HTML KBD Command
- TODO: receive user input.
#+BEGIN_SRC emacs-lisp
  (defun config/org-html-kbd-macro ()
    (interactive)
    (if (use-region-p)
        (save-excursion
          (save-restriction
...
- Prambors
#+BEGIN_SRC emacs-lisp
  (defun config/prambors-radio ()
    (interactive)
    (call-process "vlc" nil 0 nil "-I" "dummy" "-q" "http://masima.rastream.com/masima-pramborsjakarta"))
#+END_SRC
* Hooks
** Programming modes
- Infer indentation
...
#+BEGIN_SRC emacs-lisp
(defun _config/before-save-hook ()
    (when (derived-mode-p 'prog-mode)
      (delete-trailing-whitespace)))

  (add-hook 'before-save-hook '_config/before-save-hook)
#+END_SRC
