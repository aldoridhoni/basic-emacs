...
- thingatpt+.el
#+BEGIN_SRC emacs-lisp
  (quelpa '(thingatpt+ :fetcher url :url "https://www.emacswiki.org/emacs/download/thingatpt+.el" :stable nil :update nil :version original))
#+END_SRC

- strings.el
#+BEGIN_SRC emacs-lisp
  (quelpa '(strings :fetcher url :url "https://www.emacswiki.org/emacs/download/strings.el" :stable nil :update nil :version original))
#+END_SRC

- misc-fns.el
#+BEGIN_SRC emacs-lisp
  (quelpa '(misc-fns :fetcher url :url "https://www.emacswiki.org/emacs/download/misc-fns.el" :stable nil :update nil :version original))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package frame-fns
    :quelpa ((frame-fns :fetcher url :url "https://www.emacswiki.org/emacs/download/frame-fns.el") :stable nil :update nil :version original))

  (use-package frame-cmds
    :quelpa ((frame-cmds :fetcher url :url "https://www.emacswiki.org/emacs/download/frame-cmds.el") :stable nil :update nil :version original))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package zoom-frm
    ...
    :quelpa ((zoom-frm :fetcher url :url "https://www.emacswiki.org/emacs/download/zoom-frm.el") :stable nil :update nil :version original)
